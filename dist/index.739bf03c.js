...
var _observerJs = require("gsap/Observer.js");
var _scrollTrigger = require("gsap/ScrollTrigger");
(0, _gsap.gsap).registerPlugin((0, _observerJs.Observer));
...
DOM.slides.forEach((slide)=>{
    slidesArr.push(new (0, _slide.Slide)(slide));
});
...
const navigate = (newPosition)=>{
    ...
    }, 'start')// Place coming slide either above (translate -100%) or below (translate 100%) and the slide__inner to the opposite translate.
    .set(upcomingSlide.DOM.el, {
        yPercent: direction === 'next' ? 100 : -100
    }, 'start').set(upcomingSlide.DOM.inner, {
        yPercent: direction === 'next' ? -100 : 100
    }, 'start')// Add current class
    .add(()=>{
        upcomingSlide.DOM.el.classList.add('slide--current');
    }, 'start')// hide the back button and show back the cursor text if the current slide was open
    .add(()=>{
        if (currentSlide.isOpen) toggleCursorBackTexts();
    }, 'start')// Current slide moves either up or down (translate 100% or -100%)
    .to(currentSlide.DOM.el, {
        yPercent: direction === 'next' ? -100 : 100
    }, 'start').to(currentSlide.DOM.imgInner, {
        scaleY: 2
    }, 'start')// Upcoming slide translates to 0
    .to([
        upcomingSlide.DOM.el,
        upcomingSlide.DOM.inner
    ], {
        yPercent: 0
    }, 'start').to(upcomingSlide.DOM.imgInner, {
        ease: 'power2.inOut',
        startAt: {
            scaleY: 2
        },
...
const toggleCursorBackTexts = (isContent)=>{
    return (0, _gsap.gsap).timeline({
        onStart: ()=>{
            (0, _gsap.gsap).set(DOM.backChars, {
                opacity: isContent ? 0 : 1
            });
            if (isContent) DOM.backCtrl.classList.add('frame__back--show');
        },
        onComplete: ()=>{
            DOM.backCtrl.classList[isContent ? 'add' : 'remove']('frame__back--show');
            if (!isContent) DOM.backCtrl.classList.remove('frame__back--show');
        }
    }).to(DOM.cursorChars, {
        duration: 0.1,
        ease: 'expo',
...
const showContent = (position)=>{
    ...
    }, 'start').to(slide.DOM.img, {
        yPercent: -100
    }, 'start').set(slide.DOM.imgInner, {
        transformOrigin: '50% 100%'
    }, 'start').to(slide.DOM.imgInner, {
        yPercent: 100,
        scaleY: 2
    }, 'start').to(slide.DOM.contentImg, {
        startAt: {
...
const hideContent = (slide, animate = false)=>{
    ...
    if (animate) (0, _gsap.gsap).timeline({
        defaults: {
            duration: 1.6,
            ease: 'power3.inOut'
        },
        onComplete: complete
    }).addLabel('start', 0).to(slide.DOM.img, {
        yPercent: 0
    }, 'start').to(slide.DOM.imgInner, {
        yPercent: 0,
        scaleY: 1
        ...
        (0, _gsap.gsap).set(slide.DOM.img, {
            yPercent: 0
        });
        (0, _gsap.gsap).set(slide.DOM.imgInner, {
            yPercent: 0,
            scaleY: 1
        });
        complete();
...
const initEvents = ()=>{
    ...
    }); // Add missing closing bracket and semicolon here
    // Back click
    ...
    for (const [position, slide] of slidesArr.entries())slide.DOM.img.addEventListener('click', ()=>{
...
new (0, _cursor.CursorText)(DOM.cursor);
...
},{"gsap":"fPSuC","splitting/dist/splitting.css":"3uR7n","splitting/dist/splitting-cells.css":"7jeGL","splitting":"77jB6","./utils":"72Dku","./cursor":"3v1v0","./slide":"a2l79","gsap/Observer.js":"aAWxM","gsap/ScrollTrigger":"7wnFk","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fPSuC":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"./gsap-core.js":"05eeC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3uR7n":[function() {},{}],"7jeGL":[function() {},{}],"77jB6":[function(require,module,exports,__globalThis) {
...
},{}],"72Dku":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{}],"3v1v0":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
/**
 * Class representing a .cursor element
 */ parcelHelpers.export(exports, "CursorText", ()=>CursorText);
var _utils = require("./utils");
...
window.addEventListener('mousemove', (ev)=>cursor = (0, _utils.getCursorPos)(ev));
class CursorText {
    // DOM elements
    DOM = {
        // Main element (.cursor)
...
},{"./utils":"72Dku","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"a2l79":[function(require,module,exports,__globalThis) {
/**
...
class Slide {
	 ...
	 */ constructor(DOM_el){
        ...
        this.DOM.contentTexts = [
            ...this.DOM.content.children
        ].filter((item)=>item != this.DOM.contentImg);
    }
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"aAWxM":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7wnFk":[function(require,module,exports,__globalThis) {
/*!
...
},{"./Observer.js":"aAWxM","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["8G2QE","ebWYT"], "ebWYT", "parcelRequire94c2")
